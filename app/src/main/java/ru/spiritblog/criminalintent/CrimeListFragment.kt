...
class CrimeListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        crimeRecyclerView = view.findViewById(R.id.recyclerView) as RecyclerView
    ...
    private inner class CrimeHolder(view: View) : RecyclerView.ViewHolder(view),
        ...
        private val solvedImageView: ImageView = itemView.findViewById(R.id.imageCrimeSolved)
